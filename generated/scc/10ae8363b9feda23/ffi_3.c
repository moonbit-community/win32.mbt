...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a52e5558c8d9ef5d98742fba(void * h_wnd, int32_t n_index, int32_t dw_new_long, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ca707902702a2606324b749d(void * h_wnd, void * lpwndpl, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dea31a93beca06657208e3b7(void * h_wnd, void * h_wnd_insert_after, int32_t x, int32_t y, int32_t cx, int32_t cy, uint32_t u_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8ac6183965c4050185913ab2(void * h_wnd, void * lp_string, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_608543ee1eab2bd341546e9a(void * h_wnd, void * lp_string, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_3f18f866918ef96d838ac8ec(void * h_wnd, int32_t n_index, uint32_t w_new_word) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_eb724d05a61097cc13a6b470(int32_t n_filter_type, void * pfn_filter_proc) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_d8992bd61ba7c6d9d19daf12(int32_t id_hook, void * lpfn, void * hmod, uint32_t dw_thread_id, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_e5a53ae619cad7ea16872b21(int32_t id_hook, void * lpfn, void * hmod, uint32_t dw_thread_id, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_775424dafd16dd50f35c025f(int32_t n_filter_type, void * pfn_filter_proc) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6ebfaf4a0852b1a1f26d9613(void * h_wnd, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_786dec6391eb182e6e9a6b28(int32_t b_show) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4e63004e22232dbe37a21f51(void * h_wnd, int32_t f_show, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8876b797ca7e39dfcc0ebfa0(void * h_wnd, int32_t n_cmd_show) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9a2f59991a67baa04a3348cb(void * h_wnd, int32_t n_cmd_show) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2b63c00a3e9cd75c6d537756(void) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_c61358cd1addadcae0190b93(void * hwnd, int32_t f_unknown) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e86dad067596fccd1c43785b(uint32_t ui_action, uint32_t ui_param, void * pv_param, uint32_t f_win_ini, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a41bcb48b40e668d1929130c(uint32_t ui_action, uint32_t ui_param, void * pv_param, uint32_t f_win_ini, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9ac15328dc86f8b408b31df0(void * hwnd_parent, uint32_t w_how, void * lp_rect, uint32_t c_kids, void * lp_kids, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a8e38a6c2608599d13c6badd(void * h_menu, uint32_t u_flags, int32_t x, int32_t y, int32_t n_reserved, void * h_wnd, void * prc_rect, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a2aef7c04e79a51fd6da0d10(void * h_menu, uint32_t u_flags, int32_t x, int32_t y, void * hwnd, void * lptpm, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d1f439bc0b5c0cad6476f8d2(void * h_wnd, void * h_acc_table, void * lp_msg, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_457fb1355f0bcf2db741c1f2(void * h_wnd, void * h_acc_table, void * lp_msg, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5ab27dab7b46624ff47f5993(void * h_wnd_client, void * lp_msg) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_eddbfcee5764b178d308e660(void * lp_msg) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8691e4b107eba59492cebd70(int32_t n_code, void * pfn_filter_proc) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_af0b3b483198b0a50eb706bd(void * hhk, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a76a0b420501ff43c9c09db0(void * lp_class_name, void * h_instance, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ebcf9b47938110b192162ca7(void * lp_class_name, void * h_instance, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f8e793947254262f5b806f00(void * handle, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5eb700bacc13cabbb9836320(void * h_wnd, void * hdc_dst, void * ppt_dst, void * psize, void * hdc_src, void * ppt_src, uint32_t cr_key, void * pblend, uint32_t dw_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6f8be4594fca05947819e92d(void * h_wnd, void * p_ulw_info) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9c26a0e562a9286a56db43f3(uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b91d71b92819dbeddc05aefb(moonbit_bytes_t point) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_2b6e2fee429a977c0c80e8b7(moonbit_bytes_t point) {
  if (Moonbit_array_length(point) < 8) {
  return NULL;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2f734efdfc7e371280274f89(void * param0, void * param1, void * arglist, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b00724f08e790a2fdf732082(void * param0, void * param1, void * arglist, uint32_t *last_error_) {
