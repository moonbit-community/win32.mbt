...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_6b9e4e20d0d88e90cb60e455(void * nv_token) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_67fdbabf9de869db3f54711c(void * nv_token, void * nv_destination, uint64_t size, uint32_t value, uint32_t flags) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c099f0c2401a6aacac97df7d(void * nv_token, void * nv_buffer, uint64_t size, uint32_t flags) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_679fc0f90ebfd51ebff84956(void * nv_token, void * nv_ranges, uint64_t num_ranges, uint32_t flags) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a6fcc9e26373901f648d6635(void * nv_token) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_68af7cead46cec3099f9ee4d(void * nv_buffer, uint64_t size, void * nv_token) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9c1aeb2c05aa48d5534d4202(void * nv_token, void * nv_destination, void * source, uint64_t size, uint32_t flags) {
