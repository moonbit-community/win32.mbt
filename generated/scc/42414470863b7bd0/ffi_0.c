...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_5f6743c81fb207e66ac57d81(void * pa_raw_input, int32_t n_input, uint32_t cb_size_header) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_48d67c4f503fc5f823f7bd54(void * input_message_source) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_39ba349bb043a7acf34dc776(void * input_message_source, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_3f233380c5a2513dabce13f2(void * p_data, void * pcb_size, uint32_t cb_size_header, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9523d66ad765ea28ba59ddd5(void * h_raw_input, uint32_t ui_command, void * p_data, void * pcb_size, uint32_t cb_size_header) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_940c0c42624608741162501d(void * h_device, uint32_t ui_command, void * p_data, void * pcb_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_93c9a9e935721c67153ac8e2(void * h_device, uint32_t ui_command, void * p_data, void * pcb_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_64c7de8b957d186e0ad89cf8(void * p_raw_input_device_list, void * pui_num_devices, uint32_t cb_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_d8a537359d217a5c519fd623(void * p_raw_input_devices, void * pui_num_devices, uint32_t cb_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d192456652b3d78691c1b98f(void * p_raw_input_devices, uint32_t ui_num_devices, uint32_t cb_size, uint32_t *last_error_) {
