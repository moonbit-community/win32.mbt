...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5f77ab2a38012c5913eab7a4(void * file_handle, void * function, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bb5fd35bd90bc3a8a8dfa68c(void * h_file, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_71b336fb7ae93e10b08a2606(void * h_file, void * lp_overlapped, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_963c1bb9fb0c55365b35caab(void * h_thread, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b368ee43bf1fab05f31f4a26(void * file_handle, void * existing_completion_port, uint64_t completion_key, uint32_t number_of_concurrent_threads, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_30b8f89aecbdc44102fcd344(void * h_device, uint32_t dw_io_control_code, void * lp_in_buffer, uint32_t n_in_buffer_size, void * lp_out_buffer, uint32_t n_out_buffer_size, void * lp_bytes_returned, void * lp_overlapped, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f753d49ee26110406baaf63c(void * h_file, void * lp_overlapped, void * lp_number_of_bytes_transferred, int32_t b_wait, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_79e1a5eb0b587aa470c35862(void * h_file, void * lp_overlapped, void * lp_number_of_bytes_transferred, uint32_t dw_milliseconds, int32_t b_alertable, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c1f38b3067226a62e08ce4af(void * completion_port, void * lp_number_of_bytes_transferred, void * lp_completion_key, void * lp_overlapped, uint32_t dw_milliseconds, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b9bc8b0cf7dfab759c692a3e(void * completion_port, void * lp_completion_port_entries, uint32_t ul_count, void * ul_num_entries_removed, uint32_t dw_milliseconds, int32_t f_alertable, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_17dfec8f64d06e00974e5281(void * completion_port, uint32_t dw_number_of_bytes_transferred, uint64_t dw_completion_key, void * lp_overlapped, uint32_t *last_error_) {
