...
MOONBIT_FFI_EXPORT
void * moonbit_win32_73296923c4c94fc31edd6710(void * hkl, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_46f82a7a6142fca694ec425b(int32_t f_block_it, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dc0796abf15f10e536cf4f5a(void * hwnd, moonbit_bytes_t pt) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7badda88c3a42eb78b363f3c(void * h_wnd, int32_t b_enable) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_ee1ab0403e5622c37d83b41c(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_edd7deab4dee84e842d89d8a(int32_t v_key) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_4d11eb71ac4b99f446cbd8e0(void) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_2f37cd5c8fabfb7458bfa69f(void) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_95b4759ea27b48751e19af29(void) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b5fe54aa973be7b39e987e82(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d7c0a814834d3afff996673b(int32_t l_param, void * lp_string, int32_t cch_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1e52c034ddd90cb7f8931dee(int32_t l_param, void * lp_string, int32_t cch_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_49508019cfdbcccddc9ef74f(int32_t n_virt_key) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_4c2e44dfb7c11fc8f67f8744(uint32_t id_thread) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a2923ae129ff283f20cec897(int32_t n_buff, void * lp_list, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_59a60459435f7d1ef0ad153c(void * pwsz_klid, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_0e6d13e23222d706a68b7702(void * pwsz_klid, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7131a611850777c97594ae49(void * lp_key_state, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6bae3ab0806ea13d3202aba3(int32_t n_type_flag, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c097b879876d8af6b75fde6d(void * plii) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_383eafc3b959de34972a777d(uint32_t cb_size, void * lppt, void * lppt_buf, int32_t n_buf_points, uint32_t resolution, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5a9d681b586828d15707518a(void * h_wnd) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b708983bf7caacb1c14f67ff(void * pwsz_klid, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_6cde49f124c69fd856ab7b2b(void * pwsz_klid, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_2a2098f6c82b14f3dbe32a4e(uint32_t u_code, uint32_t u_map_type) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b08837785d4fc281a9932176(uint32_t u_code, uint32_t u_map_type, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f8d8f5ce7431bf1b3b2aa293(uint32_t u_code, uint32_t u_map_type, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c3a2271fca32fcda7fc448b2(uint32_t u_code, uint32_t u_map_type) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_8ce1e5d7b6184047abd848b2(uint32_t w_oem_char) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_23297c24738307b8794ac0f9(void * h_wnd, int32_t id, uint32_t fs_modifiers, uint32_t vk, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a77e7205fa0daed8e5cddd99(uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_3cc9069d40cecf972d8729f1(uint32_t c_inputs, void * p_inputs, int32_t cb_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_674b533c229a9f8b44d88633(void * h_wnd, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_72f48f65de4b9680c5281170(void * h_wnd) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_db349eb3eb3784bb6f3bac77(uint32_t param0, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_9ffd9ec9c9038b81425892a3(void * h_wnd, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_70711f4224a567b6605f97da(void * lp_key_state, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_54677201b7336fbc6555431e(int32_t f_swap) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b8810cc807bffefc7d4366d4(uint32_t u_virt_key, uint32_t u_scan_code, void * lp_key_state, void * lp_char, uint32_t u_flags) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fc2f12864646c3908e78adcc(uint32_t u_virt_key, uint32_t u_scan_code, void * lp_key_state, void * lp_char, uint32_t u_flags, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1c44d3ec9729a9d6a762bc19(uint32_t w_virt_key, uint32_t w_scan_code, void * lp_key_state, void * pwsz_buff, int32_t cch_buff, uint32_t w_flags) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a86b42d3a2c28b3e2db97d09(uint32_t w_virt_key, uint32_t w_scan_code, void * lp_key_state, void * pwsz_buff, int32_t cch_buff, uint32_t w_flags, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b7db07f8ec1377719e672e16(void * lp_event_track, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2804a036eb772a40b04fbc8f(void * hkl, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6620194760e6102762fb12cf(void * h_wnd, int32_t id, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_41faf01622fc858761dc2a0a(int32_t ch) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_59dd324127f2bdf0608aa8e8(int32_t ch, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f138ddaca6e6f73b18f66911(uint32_t ch, void * dwhkl) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_043479280287c574895fd3bb(uint32_t ch) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b5fef753c5a436ca05df1a34(void * lp_event_track) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_b6a167e607cf68e122c60044(uint32_t b_vk, uint32_t b_scan, uint32_t dw_flags, uint64_t dw_extra_info) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_697a457bfe3961905164b52b(uint32_t dw_flags, int32_t dx, int32_t dy, int32_t dw_data, uint64_t dw_extra_info) {
