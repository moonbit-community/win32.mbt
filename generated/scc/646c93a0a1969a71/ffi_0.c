...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d03b4e1338ccef92675d1e0f(void * h_service, uint32_t dw_info_level, void * lp_info, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ac91b2600685edef20363604(void * h_service, uint32_t dw_info_level, void * lp_info, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8f37fa763d1ba0484fbe1b3e(void * h_service, uint32_t dw_service_type, uint32_t dw_start_type, uint32_t dw_error_control, void * lp_binary_path_name, void * lp_load_order_group, void * lpdw_tag_id, void * lp_dependencies, void * lp_service_start_name, void * lp_password, void * lp_display_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d4262fbcf476fa7c674021de(void * h_sc_object, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4c6aa06fc49b12bf88ccae1f(void * h_service, uint32_t dw_control, void * lp_service_status, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c30c6a3f5b3966b96d55bca5(void * h_service, uint32_t dw_control, uint32_t dw_info_level, void * p_control_params, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_62ce866093aa75aa3a627dc5(void * h_service, uint32_t dw_control, uint32_t dw_info_level, void * p_control_params, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c60e65434fed364b6034e8d4(void * h_service, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7ec724a4a162c5ad928baa06(void * h_service, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_acf937c486fcb9df69a952d3(void * h_service, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_3b9ed38ffac705b5c3a4b06f(void * h_sc_manager, uint32_t dw_service_type, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, void * lp_resume_handle, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c97102cc38d33e3f94aa48f9(void * h_sc_manager, int32_t info_level, uint32_t dw_service_type, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, void * lp_resume_handle, void * psz_group_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c166be8d19ee59dadf304b6e(void * h_sc_manager, int32_t info_level, uint32_t dw_service_type, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, void * lp_resume_handle, void * psz_group_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_57521f87b1381db23584feea(void * h_sc_manager, uint32_t dw_service_type, uint32_t dw_service_state, void * lp_services, uint32_t cb_buf_size, void * pcb_bytes_needed, void * lp_services_returned, void * lp_resume_handle, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_46487fd2688f25c9e77b11c8(void * h_service_status, int32_t e_directory_type, void * lp_path_buffer, uint32_t cch_path_buffer_length, void * lpcch_required_buffer_length) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_3ca3affd671cbd1fb4e45c63(void * h_sc_manager, void * lp_service_name, void * lp_display_name, void * lpcch_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7dc566f4f5d5b96fc57605a8(void * h_sc_manager, void * lp_service_name, void * lp_display_name, void * lpcch_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9daba720e1e955c21ca30801(void * h_sc_manager, void * lp_display_name, void * lp_service_name, void * lpcch_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c2b378b80be3071911d017ea(void * h_sc_manager, void * lp_display_name, void * lp_service_name, void * lpcch_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_cff76ca53d7ac3a1cd4e0946(void * service_status_handle, int32_t state_type, uint32_t access_mask, void * service_state_key) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_42b9ef2897b32fca31f2b03b(void * service_handle, int32_t directory_type, void * path_buffer, uint32_t path_buffer_length, void * required_buffer_length) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_fb66d0afcec91552dfe17f3f(void * service_handle, int32_t state_type, uint32_t access_mask, void * service_state_key) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_84077921e87ff7d5a32da4f2(void * h_sc_manager, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_475740bb5ea67da6fe8f4a30(int32_t boot_acceptable, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9155e141c259bf7abc2aa46e(void * h_service, uint32_t dw_notify_mask, void * p_notify_buffer) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_62cfcfd15002b275b840e763(void * h_service, uint32_t dw_notify_mask, void * p_notify_buffer) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_3b90e34da12a88ec582b260d(void * lp_machine_name, void * lp_database_name, uint32_t dw_desired_access, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_a8b1c3209775ee11d9e9afbc(void * lp_machine_name, void * lp_database_name, uint32_t dw_desired_access, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_c7ecf5bd3d041be4c2db345a(void * h_sc_manager, void * lp_service_name, uint32_t dw_desired_access, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_c6a26fb322cf9515a66a4907(void * h_sc_manager, void * lp_service_name, uint32_t dw_desired_access, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8c24df352cef32b983800c7c(void * h_service, uint32_t dw_info_level, void * lp_buffer, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_73f081cbd5fd7e39e0db27bf(void * h_service, uint32_t dw_info_level, void * lp_buffer, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bb9974cab9d7b8013a689b65(void * h_service, void * lp_service_config, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e7e0c21245797d569ec6e713(void * h_service, void * lp_service_config, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_67ee7e1292cde098b2b3dab9(void * h_service_status, uint32_t dw_info_level, void * pp_dynamic_info, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_0372d7941c77c13d09e35f75(void * h_sc_manager, void * lp_lock_status, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2b8500a622d10a958eb5bb6c(void * h_sc_manager, void * lp_lock_status, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_80536c3563a8c6be375bee8d(void * h_service, uint32_t dw_security_information, void * lp_security_descriptor, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_be0b072f01a73c90ec177dfc(void * h_service, void * lp_service_status, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9eb45dfcc85cdfecd9a12800(void * h_service, int32_t info_level, void * lp_buffer, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_c788b8f7098dac6f43d7645b(void * lp_service_name, void * lp_handler_proc, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_60e11da978e17b7f1efa228d(void * lp_service_name, void * lp_handler_proc, void * lp_context, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_d371b1b2cee88ca8de451455(void * lp_service_name, void * lp_handler_proc, void * lp_context, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_07c08004dfe7e8ade1df10bd(void * lp_service_name, void * lp_handler_proc, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e652e622229e6795cb495c4a(void * h_service_status, uint32_t dw_service_bits, int32_t b_set_bits_on, int32_t b_update_immediately, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_52f2587861f9e96eefef692b(void * h_service, uint32_t dw_security_information, void * lp_security_descriptor, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_64de025cb93f7bdf929b2f10(void * h_service_status, void * lp_service_status, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_98fb35b4aba9eee87940ac5e(void * h_service, uint32_t dw_num_service_args, void * lp_service_arg_vectors, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4cb0432ad10c2dc7c62ee6c0(void * lp_service_start_table, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dddb03bee8b6a59217cbc46c(void * lp_service_start_table, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bb0254b770c9da906530023d(void * h_service, uint32_t dw_num_service_args, void * lp_service_arg_vectors, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_2542f8824a73d8a97f5be8d0(void * h_service, int32_t e_event_type, void * p_callback, void * p_callback_context, void * p_subscription) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e589f4a6aaec3530c4833813(void * sc_lock, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_699e5ad1c3a92c66ffed46b2(int64_t p_subscription) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b51da2e08308bbe740dc6bb4(void * h_service, uint32_t dw_notify, uint32_t dw_timeout, void * h_cancel_event) {
