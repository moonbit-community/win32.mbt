...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bf118b3e4a60dea424ef2955(void * lp_machine_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1df35aa05d0a816af1a2170f(void * lp_machine_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_451aac10aff7f2e1f6eccb4c(void * p_hiberboot, uint32_t b_clear_flag) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cb01cecb9e55ec4a4d5af61c(uint32_t u_flags, uint32_t dw_reason, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_92d2e44dbcfe69f9ee7e88e3(void * lp_machine_name, void * lp_message, uint32_t dw_grace_period, uint32_t dw_shutdown_flags, uint32_t dw_reason) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_ef5ae0aa7f7f32ede2a17e05(void * lp_machine_name, void * lp_message, uint32_t dw_grace_period, uint32_t dw_shutdown_flags, uint32_t dw_reason) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_83fad94aa298d5fb46cdf4cc(void * lp_machine_name, void * lp_message, uint32_t dw_timeout, int32_t b_force_apps_closed, int32_t b_reboot_after_shutdown, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7bfd9b81c5eb18bb86896be7(void * lp_machine_name, void * lp_message, uint32_t dw_timeout, int32_t b_force_apps_closed, int32_t b_reboot_after_shutdown, uint32_t dw_reason, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6fbbf6c37d84987f6afd16c7(void * lp_machine_name, void * lp_message, uint32_t dw_timeout, int32_t b_force_apps_closed, int32_t b_reboot_after_shutdown, uint32_t dw_reason, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_52ad5f2f0c5901b63c246cf1(void * lp_machine_name, void * lp_message, uint32_t dw_timeout, int32_t b_force_apps_closed, int32_t b_reboot_after_shutdown, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4f73a89a258ddadab788c6ca(uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e37a1ad90274b3c154c1ecbc(void * h_wnd, void * pwsz_reason, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_926b5ef6e42bd499dd81cdc1(void * h_wnd, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c7a2f8d7115f9ecea92f13da(void * h_wnd, void * pwsz_buff, void * pcch_buff, uint32_t *last_error_) {
