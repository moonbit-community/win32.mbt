...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ca00a65922ca6e140870edac(void * pfn_call_back, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d351491475ee3359c146720b(void * h_process, void * number_of_pages, void * page_array, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bf6a62eace02ae2f0b05800f(void * object_handle, void * number_of_pages, void * page_array, void * extended_parameters, uint32_t extended_parameter_count) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_85d61898ef30557f5656c436(void * h_process, void * number_of_pages, void * page_array, uint32_t nnd_preferred, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_e3fbc8afa2385880c6ceb688(void * file, void * security_attributes, uint32_t desired_access, uint32_t page_protection, uint32_t allocation_attributes, uint64_t maximum_size, void * name, void * extended_parameters, uint32_t parameter_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_df7d289e6b37876e5599714f(void * h_file, void * lp_file_mapping_attributes, uint32_t fl_protect, uint32_t dw_maximum_size_high, uint32_t dw_maximum_size_low, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_fffcd0e5eed36ca39b11ce4c(void * h_file, void * security_attributes, uint32_t page_protection, uint64_t maximum_size, void * name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_5c03154102ff36dd103bcf1f(void * h_file, void * lp_file_mapping_attributes, uint32_t fl_protect, uint32_t dw_maximum_size_high, uint32_t dw_maximum_size_low, void * lp_name, uint32_t nnd_preferred, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_664fefdb49561d543bf10700(void * h_file, void * lp_file_mapping_attributes, uint32_t fl_protect, uint32_t dw_maximum_size_high, uint32_t dw_maximum_size_low, void * lp_name, uint32_t nnd_preferred, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_6c56bf4fac51ce845a2fc081(void * h_file, void * lp_file_mapping_attributes, uint32_t fl_protect, uint32_t dw_maximum_size_high, uint32_t dw_maximum_size_low, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_1ede8bf05fd9a7151d42c111(int32_t notification_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_97d9d784ea7decdca0a84f85(void * virtual_address, uint64_t size) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dd3d0cab35154aeda558d0ba(void * lp_base_address, uint64_t dw_number_of_bytes_to_flush, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b4bda3a64f5b220a328853c2(void * h_process, void * number_of_pages, void * page_array, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_a0105cebf12765c57caa27b7(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_893b67fe3da7de1a7c84c506(void * capabilities, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f0e4300f80f26d04602b5f9f(uint32_t target_node_number, void * initiator_node_number) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8c819b2cb6b0575f0aeddb74(uint32_t node_number, uint32_t data_type, void * perf_info) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_53fa082e729fcc65d8cfb13e(uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_33afe0d9aa04a7fe4f01edb3(uint32_t number_of_heaps, void * process_heaps, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6a0f508e0f06c6bf4164489a(void * h_process, void * lp_minimum_working_set_size, void * lp_maximum_working_set_size, void * flags) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b7e704526049e8930658c13d(void * lp_minimum_file_cache_size, void * lp_maximum_file_cache_size, void * lp_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c73196f6cec6096a0d54c4e0(uint32_t dw_flags, void * lp_base_address, uint64_t dw_region_size, void * lp_addresses, void * lpdw_count, void * lpdw_granularity) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_1260a42a067bd82cd4f9c18c(uint32_t u_flags, uint64_t dw_bytes, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_1c29e111c4206d641d0306cd(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_be016d8e2c5b947876f15fd1(void * p_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_7ac952f2199be8d75b463c85(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_d23d95628c8d9afee2247f39(void * h_mem, uint64_t dw_bytes, uint32_t u_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_803823a556dc1e77cd4205fa(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9f2106a27f5260708363ae00(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_cf1bff641df6a3d8a2b03ee7(void * h_heap, uint32_t dw_flags, uint64_t dw_bytes) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_784b303e7ad94e09f0a3d2c0(void * h_heap, uint32_t dw_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_0e004dccdf984df6e8fec57d(uint32_t fl_options, uint64_t dw_initial_size, uint64_t dw_maximum_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fc2b9f5a17a186dc94ae67c6(void * h_heap, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7983e16f6b1e2f9c68162f72(void * h_heap, uint32_t dw_flags, void * lp_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5688797fc2699e8df81ba710(void * h_heap, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f9567712f84fa881f71a8917(void * heap_handle, int32_t heap_information_class, void * heap_information, uint64_t heap_information_length, void * return_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b2690ec6dac8d9d0012d6629(void * h_heap, uint32_t dw_flags, void * lp_mem, uint64_t dw_bytes) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_88759ffd37ef7fcd98ad0894(void * heap_handle, int32_t heap_information_class, void * heap_information, uint64_t heap_information_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_907db307a7d52d0f41d6b7f7(void * h_heap, uint32_t dw_flags, void * lp_mem) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5c9aa5a1330e8769ec659004(void * h_heap, uint32_t dw_flags, void * lp_summary) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9d339ffebe27e9e191f98e2c(void * h_heap, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_38a0e0c17068ec369e993ff4(void * h_heap, uint32_t dw_flags, void * lp_mem) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b2a52f0b534495e426a64df4(void * h_heap, void * lp_entry, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bb74434057c72bf5f47354ac(void * lpfn, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5917e9b69642d0ebd339bf5b(void * lp, uint64_t ucb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4275e43b8bb772482b24d03a(void * lpsz, uint64_t ucch_max) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_59efc3c1aaefc4f4db1de7f2(void * lpsz, uint64_t ucch_max) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ded074be011ed3013a78a39a(void * lp, uint64_t ucb) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_227fbbbdf1a2200247fd9791(uint32_t u_flags, uint64_t u_bytes, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a1504a3891947c6ca0a7660e(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_6adf612cc385d9cdb242db91(void * p_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_229623a6aecd1ab5ee8aadbf(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_7a750e69ca910cd1c049a6f2(void * h_mem, uint64_t u_bytes, uint32_t u_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_88367ee909cc2b482a1f71ab(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9ae1d0bbffd88ca6d5a364d8(void * h_mem, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_0201cc48bc06d7d3d800950d(void * virtual_address, uint64_t number_of_pages, void * page_array, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e847e58262429a2208e1aaec(void * virtual_addresses, uint64_t number_of_pages, void * page_array, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_2a70e6c4d81adac21f23d024(void * h_file_mapping_object, uint32_t dw_desired_access, uint32_t dw_file_offset_high, uint32_t dw_file_offset_low, uint64_t dw_number_of_bytes_to_map, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_09b324b71376fa25e5974856(void * file_mapping, void * process, void * base_address, uint64_t offset, uint64_t view_size, uint32_t allocation_type, uint32_t page_protection, void * extended_parameters, uint32_t parameter_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_475baab5799a1ce6f0a55219(void * file_mapping, void * process, void * base_address, uint64_t offset, uint64_t view_size, uint32_t allocation_type, uint32_t page_protection, void * extended_parameters, uint32_t parameter_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_e30fb60e00ed27fc04a3067e(void * h_file_mapping_object, uint32_t dw_desired_access, uint32_t dw_file_offset_high, uint32_t dw_file_offset_low, uint64_t dw_number_of_bytes_to_map, void * lp_base_address, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_ff71fe22a400c32c4d0f3ecf(void * h_file_mapping_object, uint32_t dw_desired_access, uint32_t dw_file_offset_high, uint32_t dw_file_offset_low, uint64_t dw_number_of_bytes_to_map, void * lp_base_address, uint32_t nnd_preferred, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_45cbd24b61f624aec18825bd(void * h_file_mapping_object, uint32_t desired_access, uint64_t file_offset, uint64_t number_of_bytes_to_map, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_db7d34c89138c65ec792552a(void * file_mapping_handle, void * process_handle, uint64_t offset, void * base_address, uint64_t view_size, uint32_t allocation_type, uint32_t page_protection, uint32_t preferred_node, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_e16a66c16df1c893c3aa5663(void * virtual_address, uint64_t size, int32_t priority) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_7271c9ef54af48f3b4b04686(void * partition, uint64_t dedicated_memory_type_id, uint32_t desired_access, int32_t inherit_handle) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_c660e97c4aefb766fc20ab34(uint32_t dw_desired_access, int32_t b_inherit_handle, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_59560ca1048d8a2816f4f3df(uint32_t desired_access, int32_t inherit_handle, void * name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_a01e94c74945d453d3c7400e(uint32_t dw_desired_access, int32_t b_inherit_handle, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7ae5b1763a0b9567967b1b1d(void * h_process, uint64_t number_of_entries, void * virtual_addresses, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fab5d65a80b37c70774bc171(void * resource_notification_handle, void * resource_state, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_700b215675a6a1f878cb2cba(void * partition, int32_t partition_information_class, void * partition_information, uint32_t partition_information_length) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4bedd46d4c3a2cf088415eaf(void * process, void * virtual_address, int32_t memory_information_class, void * memory_information, uint64_t memory_information_size, void * return_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_681e65af9e4f001864cdfd64(void * virtual_address, uint64_t size) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_6d77abc0109af26e5467be1b(void * callback) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ce48cc931cdbd0f14a827859(void * pfn_call_back) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_e489a5ec86ceeb2e72cc9701(void * lp_base_address, uint64_t dw_region_size) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_2e55d5df82aec88c4a6eaed4(void * source1, void * source2, uint64_t length) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c22d5ee141a9b73e023467d8(void * buffer, uint64_t size, uint32_t initial_crc) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_c9aeaa81c6b56c194dfa0ff6(void * buffer, uint64_t size, uint64_t initial_crc) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f1c15b340d558999c90ba180(void * buffer, uint64_t length) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ea613ca8bd14df08b4960b2d(void * h_process, void * virtual_address, uint64_t region_size, uint32_t number_of_offsets, void * offset_information, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_3448c3c15b83fe06283f0fff(void * process, void * virtual_address, uint64_t region_size, uint32_t number_of_offsets, void * offset_information, void * section, uint64_t expected_file_offset) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4178ff327f474a36fff65c82(void * h_process, uint64_t dw_minimum_working_set_size, uint64_t dw_maximum_working_set_size, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5957283fe9c30553d53b73ce(uint64_t minimum_file_cache_size, uint64_t maximum_file_cache_size, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_169565cfdb9650aa3f7c70f5(void * lp_base_address, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a287079dbe112e007f3d5c88(void * process, void * base_address, uint32_t unmap_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7532e1ce85eb36db3d5f2a71(void * base_address, uint32_t unmap_flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_80a928e5431106d8a1a07e99(void * registration_handle, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_50b5e818e0ff56d1229a52e0(void * lp_address, uint64_t dw_size, uint32_t fl_allocation_type, uint32_t fl_protect, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_300413fbc4e52b5f2aca71dd(void * process, void * base_address, uint64_t size, uint32_t allocation_type, uint32_t page_protection, void * extended_parameters, uint32_t parameter_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_2de45e326643939ca6ec9903(void * process, void * base_address, uint64_t size, uint32_t allocation_type, uint32_t page_protection, void * extended_parameters, uint32_t parameter_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_5e22af99a81830ce7e577d63(void * h_process, void * lp_address, uint64_t dw_size, uint32_t fl_allocation_type, uint32_t fl_protect, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b91dec73072550fee63634e7(void * h_process, void * lp_address, uint64_t dw_size, uint32_t fl_allocation_type, uint32_t fl_protect, uint32_t nnd_preferred, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_b00fb5acd9b076563c62df63(void * base_address, uint64_t size, uint32_t allocation_type, uint32_t protection, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d701180429e4a4cdb822360b(void * lp_address, uint64_t dw_size, uint32_t dw_free_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9e111f2a742acfd5124dc797(void * h_process, void * lp_address, uint64_t dw_size, uint32_t dw_free_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fd77c40a23a8e1146eeb87e8(void * lp_address, uint64_t dw_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_22988c272313beeae515ae0a(void * lp_address, uint64_t dw_size, uint32_t fl_new_protect, void * lpfl_old_protect, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8dd85d4424377793c1a87fc9(void * h_process, void * lp_address, uint64_t dw_size, uint32_t fl_new_protect, void * lpfl_old_protect, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_66bb9376ed857c1c4674fb88(void * address, uint64_t size, uint32_t new_protection, void * old_protection, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_103a410bec969cdf20495f79(void * lp_address, void * lp_buffer, uint64_t dw_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_ee5cd1a82b1b63b676216f55(void * h_process, void * lp_address, void * lp_buffer, uint64_t dw_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_79b17e9f081b06fffff8df70(void * lp_address, uint64_t dw_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d06f87b361c2d235c8c4461b(void * process, void * address, uint64_t size) {
