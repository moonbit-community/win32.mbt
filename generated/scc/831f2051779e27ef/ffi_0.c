...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a44ddbd9a9d25c3926538aa0(void * this_, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_495e5b21321561cb3a1845c1(void * this_, void * activated_event_args, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4ca963ea743f905e5c7b49a1(void * this_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a2c0efcbc0bc79332eaa08ab(void * this_, void * coordinate_system, moonbit_bytes_t top_center_position, moonbit_bytes_t normal) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_86c76c049253676ba3dd663c(void * this_, void * coordinate_system, moonbit_bytes_t top_center_position, moonbit_bytes_t normal, moonbit_bytes_t max_size) {
  if (Moonbit_array_length(top_center_position) < 12) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_38f3d81a6f7f87ba4dc719fc(void * this_, uint64_t * result_out) {
