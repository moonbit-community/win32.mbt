...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c2265509d341fcb98d3f5ad1(void * this_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_78a31d64067469c2ed100340(void * this_, void * coordinate_system, moonbit_bytes_t top_center_position, moonbit_bytes_t orientation) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9f18c5aff2abf80e33e4a831(void * this_, void * coordinate_system, moonbit_bytes_t top_center_position, moonbit_bytes_t orientation, moonbit_bytes_t max_size) {
  if (Moonbit_array_length(top_center_position) < 12) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_31f28114c5c233cf6d9ffdcb(void * this_, uint64_t * result_out) {
