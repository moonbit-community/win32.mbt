...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_90b78f61c9985d50ae0bcef9(void * hostname, void * computer_name, void * n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a81cf189515cc1236a86a5d5(uint32_t firmware_table_provider_signature, void * p_firmware_table_enum_buffer, uint32_t buffer_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d04178a845309f45c8458ebd(int32_t name_type, void * lp_buffer, void * n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_db5c4671e5aaa5995709ed66(int32_t name_type, void * lp_buffer, void * n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_db9cb5253ce2d0d1b2f0cd9b(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_96bd89ae0eda725b55e62307(void * firmware_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_74d268ca3b400baf3473df49(void * size_in_inches) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_42f2ab749b947453d2573d12(void * lp_system_time) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b25d58dfef950b414c6c2a89(void * buffer, void * returned_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bb4d28ce60ad31aba792832b(int32_t relationship_type, void * buffer, void * returned_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_7408e179551f26762f88a35c(void * lp_system_info) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fb66500e877c9cfc46932a11(void * pb_enabled) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_be417fadebdf1bf329610c3a(void * flags) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2236a4c25face76158cd9bba(void * total_memory_in_kilobytes, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cb07351c3fbd759e0da21042(uint32_t group, void * buffer, void * returned_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8cf5a028e4d0c0fc42f1fe52(uint32_t dw_os_major_version, uint32_t dw_os_minor_version, uint32_t dw_sp_major_version, uint32_t dw_sp_minor_version, void * pdw_returned_product_type) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_70c8f77a5a5d36a2d5387bf2(void * nonce, uint32_t package_version, uint64_t report_types_bitmap, void * report_buffer, void * report_buffer_size) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_488b12200154c220e6fa5b66(void * information, uint32_t buffer_length, void * returned_length, void * process, uint32_t flags) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cb29afdb42efb9c16468f12a(void) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f3f3afb1492c67247f9a812c(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_97c81aabec6113ec6adad8ca(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_e52a9068bc415a1d16fb91d3(uint32_t firmware_table_provider_signature, uint32_t firmware_table_id, void * p_firmware_table_buffer, uint32_t buffer_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_bb015a05e06cd0fef513e28c(void * lp_system_info) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_734422124b06e146fcc13e09(void * enabled, void * flags) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_806e2d2bc44ca082f8b2da40(void * lp_system_time) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_227b831e25d1db58815d69d2(void * lp_time_adjustment, void * lp_time_increment, void * lp_time_adjustment_disabled, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9447d195d3b3ac2837be9416(void * lp_time_adjustment, void * lp_time_increment, void * lp_time_adjustment_disabled, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_c3c8cd4f25b60583e8e1ffa1(void * lp_system_time_as_file_time) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_f57a99d1eb31e03a7604c6cd(void * lp_system_time_as_file_time) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_55008cf99f86e878784611f1(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_64fe52367e0e514dadadf5e2(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7570ee3417e4af1282f75c24(void * lp_buffer, uint32_t u_size, uint32_t image_file_machine_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_20c3ba6a032d002a42109c96(void * lp_buffer, uint32_t u_size, uint32_t image_file_machine_type, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_0733764966a4562e06e8e51c(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9ea2a6bc1f1d34c2a88692b1(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b247a80f64093d2c62d2cf46(void) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_3dc6e7650d7fdea6c386978e(void) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_981a6d98d8920b3a5190a24f(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b297f87592856b95ca7182b8(void * lp_version_information, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7156c26796b97cc6d83f2df0(void * lp_version_information, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_cb18025c408a47b8f969a886(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b95e972917018589e12a5f2f(void * lp_buffer, uint32_t u_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_d565054982c4ba63d5fdc00e(void * lp_buffer) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d963294f8c0c7e8219a3be5d(void * lp_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a9fda92334ffa6aefc55a9bf(uint32_t user_cet_environment) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_27db2f19ed76f9a205d881c3(uint32_t wow_guest_machine, void * machine_is_supported, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_757e5b5d3990a1a1e3cc6326(void * pul_device_family_buffer_size, void * pul_device_form_buffer_size, void * device_family, void * device_form) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_da0413cc32eacb6b58b13c3e(void * pull_uap_info, void * pul_device_family, void * pul_device_form) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f5785fb1bc01b7a8f21a0a53(uint32_t os_major_version, uint32_t os_minor_version, uint32_t sp_major_version, uint32_t sp_minor_version, void * returned_product_type) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_cdda12a0ad6e96eb68e88e92(int32_t data_id, void * buffer, uint32_t size) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e0294ddc6351e04a16b439ba(uint32_t flags) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_36aaa4146ca4afdb6f0e5c5a(void * version_info, uint32_t type_mask, uint64_t condition_mask) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9c06b9dbaff39ac34b6cb148(void * lp_computer_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8220696e6969ce1496357928(int32_t name_type, uint32_t flags, void * lp_buffer) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7161625aa1f91ef74dce0d8f(int32_t name_type, void * lp_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a87a97908561b33863c9132b(int32_t name_type, void * lp_buffer, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_47dbe7b6fa5a9736750c7bab(void * lp_computer_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_eea62b1bd5fc6c4170d6af24(void * lp_system_time, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2a67660be38d944e9d6f1c06(void * lp_system_time, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_90c0801750bd606611caa3a5(uint32_t dw_time_adjustment, int32_t b_time_adjustment_disabled, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_34743c4e1bb197874c1ea60b(uint64_t dw_time_adjustment, int32_t b_time_adjustment_disabled, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint64_t moonbit_win32_0d84e60e707d4124b0677ca5(uint64_t condition_mask, uint32_t type_mask, uint32_t condition) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b8f2d3664d4cc1c27739d5f4(void * lp_version_information, uint32_t dw_type_mask, uint64_t dwl_condition_mask, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_95098ac790a910f2af406ee1(void * lp_version_information, uint32_t dw_type_mask, uint64_t dwl_condition_mask, uint32_t *last_error_) {
