...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ff4cd79c6c521c86f41c77af(void * h_process, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c74de4bc91546f29bade2e94(void * lp_image_base, uint32_t cb, void * lpcb_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_be449b6502b1479bf88cc971(void * p_call_back_routine, void * p_context, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6749862959b68ecc149b64b3(void * p_call_back_routine, void * p_context, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b308c89c983fb6f01c995895(void * h_process, void * lph_module, uint32_t cb, void * lpcb_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_82a8606550eafd440fac0b94(void * h_process, void * lph_module, uint32_t cb, void * lpcb_needed, uint32_t dw_filter_flag, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2ad9cde22387f3923f80a6bf(void * lpid_process, uint32_t cb, void * lpcb_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_477bcee8c7185940588b93ac(void * image_base, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b3b1f1ad931e6e98cc00a25a(void * image_base, void * lp_base_name, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_873b9d7de46f4487f875acda(void * image_base, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f1f6aa8ba3d66bbb4602a740(void * image_base, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_3e5b94cfcb47f2562c787dc5(void * h_process, void * lpv, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_8dcd74334b9d1ebe156fc6ff(void * h_process, void * lpv, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9891deff28e70b1bf4664713(void * h_process, void * h_module, void * lp_base_name, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f73c54f16418b3e4fcc89c17(void * h_process, void * h_module, void * lp_base_name, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_cdf9504a6f0800e47f008168(void * h_process, void * h_module, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f204dbad8ed9bb49a41a335e(void * h_process, void * h_module, void * lp_filename, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fbeb5ce7482361a7787d7313(void * h_process, void * h_module, void * lpmodinfo, uint32_t cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dbe2a2dd5c442cc3dbafcf5e(void * p_performance_information, uint32_t cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_21408db99a527aba3ae5ef1a(void * h_process, void * lp_image_file_name, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_2bc4a8393ec0e0c1702cba9b(void * h_process, void * lp_image_file_name, uint32_t n_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cf7d8e76dcf5c4feb4da79a1(void * process, void * ppsmem_counters, uint32_t cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6636cbafbb2905e65ab0c132(void * h_process, void * lp_watch_info, uint32_t cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_eb7ceec7f64bd502e4af7b9d(void * h_process, void * lp_watch_info_ex, void * cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_18144de63a02e999bd7a85ba(void * h_process, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_fe4aa1948f195a190b67a00d(void * h_process) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cbc400831cb400c232d501a8(void * lp_image_base, uint32_t cb, void * lpcb_needed) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9f1a3244f8fae1207291f54f(void * p_call_back_routine, void * p_context) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4b44ccbf4cc22ca9f319c277(void * p_call_back_routine, void * p_context) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_39afed3bc63e36dbfc72edf9(void * h_process, void * lph_module, uint32_t cb, void * lpcb_needed) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d8582025b40c0d3544749ab5(void * h_process, void * lph_module, uint32_t cb, void * lpcb_needed, uint32_t dw_filter_flag) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_081978e3fc2821edeeb53101(void * lpid_process, uint32_t cb, void * lpcb_needed) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b7e438438a3aa4609f7eaaaf(void * image_base, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f1ae66538473fe04326dc790(void * image_base, void * lp_base_name, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_de61a9bc1dac73de0ac109f3(void * image_base, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b3167a5f70acc4e61d6f123d(void * image_base, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c78bbda4ea582a64156e81dc(void * h_process, void * lpv, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_be2401709e496beffe3a0e01(void * h_process, void * lpv, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_1d2312be3615e605fd01f3b0(void * h_process, void * h_module, void * lp_base_name, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f355492cd2bd603a0ea59f3d(void * h_process, void * h_module, void * lp_base_name, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_1849d7cd21254c35be300127(void * h_process, void * h_module, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7ba8f81845b90d3e7a723c5f(void * h_process, void * h_module, void * lp_filename, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b240a95f9aa5e125b734a1fb(void * h_process, void * h_module, void * lpmodinfo, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_00136dd3bf7c96bf63c7d01d(void * p_performance_information, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_1672cb55813431b22e2bb522(void * h_process, void * lp_image_file_name, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_d819d6afaadbe640325620f6(void * h_process, void * lp_image_file_name, uint32_t n_size) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_10e264815084215ffb15578d(void * process, void * ppsmem_counters, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_babde786b2d58e092fd7c23d(void * h_process, void * lp_watch_info, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_ad9ba6ad5e2f07f58971873f(void * h_process, void * lp_watch_info_ex, void * cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_281500219bba19bdd81ab6e8(void * h_process) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c5558ee4da840c82693c8ae7(void * h_process, void * pv, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f6ada31c595d6cfb7d4d8ce8(void * h_process, void * pv, uint32_t cb) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c121dc682d28c01a9ce3de13(void * h_process, void * pv, uint32_t cb, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_278ef89fd864322d112e5e0f(void * h_process, void * pv, uint32_t cb, uint32_t *last_error_) {
