...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_10a12e72fb6da8a55c42e832(void * this_, uint32_t thread_id) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4c6a07e2389e5a7365bfd647(void * this_, uint32_t pdu_data_length, moonbit_bytes_t pdu_data) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c3d4b1b22f6db03f98639c37(void * this_, uint32_t thread_id) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1ffaf468c9e0703d9a94e2c3(void * this_, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_93c6ddd05c929731728e8b24(void * this_, uint32_t value) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d2ffb80d28f04445773cfad6(void * this_, uint32_t scan_code, uint32_t attributes) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8544086cf74c03ed9771e8e7(void * this_, moonbit_bytes_t connection_id, void * pdu_forwarder, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_20744a757f85abea174ae898(void * this_, moonbit_bytes_t connection_id, void * pdu_forwarder, uint32_t options, uint64_t * result_out) {
  if (Moonbit_array_length(connection_id) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1ef229c13aeb1db1c15a4766(void * this_, uint32_t pdu_data_length, moonbit_bytes_t pdu_data, moonbit_bytes_t result_out) {
