...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a470837e5cda62b6212af7e6(void * this_, void * input_panel_visual, moonbit_bytes_t input_panel_rect, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a572553a0d05b78014f9313d(void * this_, void * input_panel_visual, moonbit_bytes_t input_panel_rect, void * viewport_visual, moonbit_bytes_t viewport_rect, uint64_t * result_out) {
  if (Moonbit_array_length(input_panel_rect) < 16) {
  return 0;
  }
