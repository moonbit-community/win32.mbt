...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_071a0d100c12619f6f968b59(uint32_t dw_session_handle, void * str_module_name, void * p_process, void * str_service_short_name, int32_t filter_action) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_08ee0dca6281af9de279513a(uint32_t dw_session_handle) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_58deabb76be07d569fdb2ea8(uint32_t dw_session_handle) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7f263ece7c0851fe140c966e(uint32_t dw_session_handle, void * pb_filter_buf, uint32_t cb_filter_buf, void * cb_filter_buf_needed) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_ba3a0f9eb7df84969d0c129c(uint32_t dw_session_handle, void * pn_proc_info_needed, void * pn_proc_info, void * rg_affected_apps, void * lpdw_reboot_reasons) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_8072b8df8cf44dc1beab132b(void * p_session_handle, void * str_session_key) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_4952bf4cf327a4fa1894afe1(uint32_t dw_session_handle, uint32_t n_files, void * rgs_file_names, uint32_t n_applications, void * rg_applications, uint32_t n_services, void * rgs_service_names) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_ece29b9f184b3064b76bfbbb(uint32_t dw_session_handle, void * str_module_name, void * p_process, void * str_service_short_name) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f0f62e957ed9605576814ec6(uint32_t dw_session_handle, uint32_t dw_restart_flags, void * fn_status) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_94193a2f3269dd7e8008ac60(uint32_t dw_session_handle, uint32_t l_action_flags, void * fn_status) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_715367329da4ef917d29f82e(void * p_session_handle, uint32_t dw_session_flags, void * str_session_key) {
