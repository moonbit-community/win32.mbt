...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_bc8bb9ea03bad589e7eccab3(void * h_console_input, void * lp_buffer, uint32_t n_length, void * lp_number_of_events_written, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_3ce68e06e85a0029194c4d18(void * h_console_input, void * lp_buffer, uint32_t n_length, void * lp_number_of_events_written) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_be4f1a1f09857e0588dbee1d(void * h_console_input, void * lp_buffer, uint32_t n_length, void * lp_number_of_events_written) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cba762b9773341260295568a(void * h_console_input, void * lp_buffer, uint32_t n_length, void * lp_number_of_events_written, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6e58e218f9822b037ada4533(void * h_console_output, void * lp_buffer, moonbit_bytes_t dw_buffer_size, moonbit_bytes_t dw_buffer_coord, void * lp_write_region, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_285addcbd98895eccf54d41f(void * h_console_output, void * lp_attribute, uint32_t n_length, moonbit_bytes_t dw_write_coord, void * lp_number_of_attrs_written, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_11e78941ea8259dde1017d5b(void * h_console_output, void * lp_character, uint32_t n_length, moonbit_bytes_t dw_write_coord, void * lp_number_of_chars_written, uint32_t *last_error_) {
  if (Moonbit_array_length(dw_write_coord) < 4) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4a774088f0728839c19f599d(void * h_console_output, void * lp_character, uint32_t n_length, moonbit_bytes_t dw_write_coord, void * lp_number_of_chars_written, uint32_t *last_error_) {
  if (Moonbit_array_length(dw_write_coord) < 4) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_10a06b7e1da7c0bc6b684552(void * h_console_output, void * lp_buffer, moonbit_bytes_t dw_buffer_size, moonbit_bytes_t dw_buffer_coord, void * lp_write_region, uint32_t *last_error_) {
  if (Moonbit_array_length(dw_buffer_size) < 4) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_19e88cec31296b79359f1c8a(void * h_console_output, void * lp_buffer, uint32_t n_number_of_chars_to_write, void * lp_number_of_chars_written, void * lp_reserved, uint32_t *last_error_) {
