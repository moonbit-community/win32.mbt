...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_3b7b8d26ab54c4d2d4a941c9(void * this_, void * partner, void * feature, uint32_t is_scenario_namespace, uint32_t download_over_costed_network, uint32_t download_over_battery, int32_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_aed25babd8fa235f7f1c1797(void * this_, uint32_t latency, uint32_t upload_over_costed_network, uint32_t upload_over_battery, int32_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7e61d74e4b324399aadcf380(void * this_, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2779b4348f0b97291b897804(void * this_, int32_t slot_type, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_da9562b231ca28ed9f2651c1(void * this_, int32_t slot_type, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_0b6a41a95d931b10d39aff4f(void * this_, moonbit_bytes_t scenario_id, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7a6061992eeba44531844f51(void * this_, int32_t slot_type, moonbit_bytes_t scenario_id, uint64_t trace_profile_hash, int32_t * result_out) {
  if (Moonbit_array_length(scenario_id) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4c24e95c37a31c96f882461d(void * this_, moonbit_bytes_t scenario_id, int32_t escalation_type, void * output_directory, uint32_t timestamp_output_directory, uint32_t force_escalation_upload, void * triggers, moonbit_bytes_t result_out) {
  if (Moonbit_array_length(scenario_id) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a002e0b5b2a9e17122e150db(void * this_, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_dbac01151b06228304712d40(void * this_, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_24023b39934c33d3da100bd7(void * this_, int64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_067f2b77a293785820b4f0c1(void * this_, int32_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9b5486c83901de1ad1edcc3f(void * this_, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b955bb3a2fbf1f2225e89e95(void * this_, moonbit_bytes_t result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_66194aa655f95b9c1e28e17b(void * this_, int64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_25a80b98f339c67b335c1782(void * this_, int64_t * result_out) {
