...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6a78619cbd7112cc1fecf547(void * this_, uint32_t access_requests_length, moonbit_bytes_t access_requests, void * principal_string_sid, uint32_t principal_access_mask, uint64_t * result_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f292209bb1a8c2c8fe3069a2(void * this_, uint32_t access_requests_length, moonbit_bytes_t access_requests, void * principal_string_sid, uint32_t principal_access_mask, uint32_t * result_length_out, uint64_t * result_data_out) {
