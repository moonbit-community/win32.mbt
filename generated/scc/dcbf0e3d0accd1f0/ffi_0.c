...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_c143853b182592bff8687c87(void * p_connection_id, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_e3e318c6ee363ffc38c9f384(uint32_t dw_flags, moonbit_bytes_t eap_method_type, uint32_t dw_size_of_config_in, void * p_config_in, void * pp_config_doc, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_bf6849ea6b43db4f12c87d68(uint32_t dw_flags, void * p_config_doc, void * pdw_size_of_config_out, void * pp_config_out, void * p_eap_method_type, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_88717c448f560f87f7c13e04(uint32_t dw_flags, void * p_credentials_doc, uint32_t dw_size_of_config_in, void * p_config_in, void * pdw_size_of_credentials_out, void * pp_credentials_out, void * p_eap_method_type, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7013b537aa2a89dd0d7d9bcc(uint32_t session_handle, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_bc6f74952ebbc892b3b09d3d(void * p_eap_error) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_93b4cb41c43008790cffdae0(void * p_eap_error) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_d0593e582dec654383284675(void * p_data) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_5e777998bc497062e405fd13(void * p_data) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_02a8f1d5321232df4aa6bdbd(uint32_t session_handle, int32_t auth_param, void * pcb_auth_data, void * pp_auth_data, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_930f54ec2f743728cb516cf2(void * p_connection_id_that_last_saved_creds, void * ph_credential_impersonation_token, uint32_t session_handle, void * pp_eap_error, void * f_save_to_cred_man) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a5819f2c0708522054e4651d(uint32_t dw_sizeof_password, void * sz_password, void * ppsz_enc_password) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_44841f20227b55f996cb2d6d(uint32_t dw_version, uint32_t dw_flags, moonbit_bytes_t eap_method_type, void * h_user_impersonation_token, uint32_t dw_eap_conn_data_size, void * pb_eap_conn_data, uint32_t dw_user_data_size, void * pb_user_data, void * p_method_property_array, void * pp_eap_error) {
  if (Moonbit_array_length(eap_method_type) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_b5b5030fcbe9bba18cf77b77(void * p_eap_method_info_array, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a975da254478fe7ea3c0856e(uint32_t session_handle, void * p_attribs, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_d76ccec9608dd38ed3d684cb(uint32_t session_handle, int32_t reason, void * pp_result, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_600e1e3acce0a1af560b1161(uint32_t session_handle, void * pcb_send_packet, void * pp_send_packet, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_03dcbd020d65dfe161239ef9(uint32_t session_handle, void * pdw_size_of_ui_context_data, void * pp_ui_context_data, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_f17ddcf4dfe3c49fa89c52ba(void) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_063ad0f2673273f288a3f285(void * hwnd_parent, uint32_t dw_flags, moonbit_bytes_t eap_method_type, uint32_t dw_size_of_config_in, void * p_config_in, void * pdw_size_of_config_out, void * pp_config_out, void * pp_eap_error) {
  if (Moonbit_array_length(eap_method_type) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7fe836a0966397892fe96573(void * hwnd_parent, uint32_t dw_sizeof_ui_context_data, void * p_ui_context_data, void * pdw_size_of_data_from_interactive_ui, void * pp_data_from_interactive_ui, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_47aaf1654645f180cd08b0bb(uint32_t session_handle, uint32_t cb_receive_packet, void * p_receive_packet, void * p_eap_output, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_9f573524ff1f4cf364fd82bc(void * h_user_impersonation_token, moonbit_bytes_t eap_method_type, uint32_t dw_flags, uint32_t dw_eap_conn_data_size, void * pb_eap_conn_data, void * p_eap_config_input_field_array, void * pp_eap_error) {
  if (Moonbit_array_length(eap_method_type) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_8e2b77d515b3febc8a1d6b7a(uint32_t dw_version, uint32_t dw_flags, uint32_t dw_sizeof_ui_context_data, void * p_ui_context_data, void * p_eap_interactive_ui_data, void * pp_eap_error, void * ppv_reserved) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_73c8b7c7d4eb288250844f13(uint32_t dw_version, uint32_t dw_flags, uint32_t dw_sizeof_ui_context_data, void * p_ui_context_data, void * p_eap_interactive_ui_data, void * pdw_size_of_data_from_interactive_ui, void * pp_data_from_interactive_ui, void * pp_eap_error, void * ppv_reserved) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_968d592792ee606eddf8407a(void * h_user_impersonation_token, moonbit_bytes_t eap_method_type, uint32_t dw_flags, uint32_t dw_eap_conn_data_size, void * pb_eap_conn_data, void * p_eap_config_input_field_array, void * pdw_user_blob_size, void * ppb_user_blob, void * pp_eap_error) {
  if (Moonbit_array_length(eap_method_type) < 16) {
  return 0;
  }
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_a09460bd533c45e8345dd1c6(uint32_t session_handle, void * p_attribs, void * p_eap_output, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_66bef201e3ab4f6bc9b17b4c(uint32_t session_handle, uint32_t dw_size_of_ui_context_data, void * p_ui_context_data, void * p_eap_output, void * pp_eap_error) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_647bbc6da777ad3e344c3854(void) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7031fd4119d4e91101d5984d(void * this_, uint64_t u_connection_param, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_73ef1b4204aa4332caa79132(void * this_, uint64_t u_connection_param, void * h_wnd, uint32_t dw_flags, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_24ccba39bcc3cc8e73accc26(void * this_, uint64_t u_connection_param, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b7381da83b1434a4ef516828(void * this_, void * psz_machine_name, void * pu_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_714f2f62d4fe17853be851ec(void * this_, uint64_t u_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9cba4c0e560ca8e4c8c45785(void * this_, uint64_t u_connection_param, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_5232f38dbe9cdf5e9d2f8cda(void * this_, uint64_t u_connection_param, void * h_wnd, uint32_t dw_flags, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a46cfa7c5a3b0528f0fd9176(void * this_, uint64_t u_connection_param, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_980afd8b3344634f37ccb4d0(void * this_, void * psz_machine_name, void * pu_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_6be1573fff4f5d9d58b11371(void * this_, uint64_t u_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_79ec7647c31cfa14556308f5(void * this_, void * psz_machine_name, uint32_t dw_eap_type_id, void * pu_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_679168b50a3bd77f9732a829(void * this_, uint32_t dw_eap_type_id, uint64_t u_connection_param, void * hwnd_parent, uint32_t dw_flags, void * p_connection_data_in, uint32_t dw_size_of_connection_data_in, void * pp_connection_data_out, void * pdw_size_of_connection_data_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_62302e26343e4de135221849(void * this_, uint32_t dw_eap_type_id, uint64_t u_connection_param, void * h_wnd, uint64_t u_reserved1, uint64_t u_reserved2) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c4b3c1cf539f23373c25cce0(void * this_, uint32_t dw_eap_type_id, uint64_t u_connection_param) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_da7f8ba03cad401af6a5a8ae(void * this_, uint32_t dw_eap_type_id, void * pp_config_data_out, void * pdw_size_of_config_data_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_7fbb1d483beca23dfbf9f4f1(void * this_, uint32_t dw_eap_type_id, uint64_t u_connection_param, void * h_wnd, void * p_config_data_in, uint32_t dw_size_of_config_data_in, void * pp_config_data_out, void * pdw_size_of_config_data_out) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_815bfe9ca1dc5ca62534cefa(void * this_, uint32_t dw_eap_type_id, uint64_t u_connection_param, void * h_wnd, void * p_config_data_in, uint32_t dw_size_of_config_data_in, void * pp_config_data_out, void * pdw_size_of_config_data_out, uint64_t u_reserved) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2f77e55aa2fe4441030d9c8c(void * this_, void * psz_machine_name, uint32_t dw_transport_id, uint32_t dw_protocol_id, void * h_wnd, uint32_t dw_flags, void * p_router, uint64_t u_reserved1) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_df4eaa32a080cc912e0b31a8(void * this_, void * psz_machine_name, uint32_t dw_transport_id, uint32_t dw_protocol_id, void * h_wnd, uint32_t dw_flags, void * p_router, uint64_t u_reserved1) {
