...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f1ea15941a0c3462c8d78387(void * h_job, void * h_process, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_5a4d1b1b6c7d15d7acf42138(void * lp_job_attributes, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_5f64a4877fab4596f87dc76a(void * lp_job_attributes, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c644e15e7a0a0e318b64998c(uint32_t num_job, void * user_job_set, uint32_t flags) {
...
MOONBIT_FFI_EXPORT
void moonbit_win32_3c8fe03a5f5484476377a1d8(void * buffer) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_71deddba0beaf5b89c29dc35(void * process_handle, void * job_handle, void * result, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_2e54ef1387e3bde2f24bc94d(uint32_t dw_desired_access, int32_t b_inherit_handle, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_1228a2475f65aefe537ca410(uint32_t dw_desired_access, int32_t b_inherit_handle, void * lp_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c12428a56d2cb18f21687f15(void * h_job, int32_t job_object_information_class, void * lp_job_object_information, uint32_t cb_job_object_information_length, void * lp_return_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_51a6b5f7201faa6bc55025cb(void * h_job, void * volume_name, void * info_blocks, void * info_block_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_10bb00798b732850cd766db8(void * h_job, int32_t job_object_information_class, void * lp_job_object_information, uint32_t cb_job_object_information_length, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_7776fc4468deeef065c6ea30(void * h_job, void * io_rate_control_info, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d9516f9fc8838490fa4f88a3(void * h_job, uint32_t u_exit_code, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f64a26d1d8de3932b578de34(void * h_user_handle, void * h_job, int32_t b_grant, uint32_t *last_error_) {
