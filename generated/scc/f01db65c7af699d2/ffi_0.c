...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_248a3e8e48c444efe9bbeaa3(void * h_event_log, void * lp_backup_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4ccc0061395837e22c344c4e(void * h_event_log, void * lp_backup_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_1099facb494d069c18ae2680(void * h_event_log, void * lp_backup_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_89c7df01030458698cff35fb(void * h_event_log, void * lp_backup_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_058002508babec7c90b66233(void * h_event_log, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_89d29db03701f736ed136649(void * h_event_log, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_19ef1788b8d8890146cdc236(int64_t session, void * log_file_path, uint32_t locale, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_80adf7d4df8af8a493ed1c45(int64_t object, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8602b4ac79746c3d443dd085(int64_t session, void * channel_path, void * target_file_path, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4aa19f2e9b158b47bded441e(int64_t object, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_5ab70724c7a31e6bea3f0be8(void * bookmark_xml, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_9ae4b23127de2f990ac6b77b(uint32_t value_paths_count, void * value_paths, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_0c71a0f8e04fe74933e223f1(int64_t session, void * path, void * query, void * target_file_path, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_c9a0ea8c1dbcbef70d127ec9(int64_t publisher_metadata, int64_t event, uint32_t message_id, uint32_t value_count, void * values, uint32_t flags, uint32_t buffer_size, void * buffer, void * buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_081498d5b4c75ec1a1abab2f(int64_t channel_config, int32_t property_id, uint32_t flags, uint32_t property_value_buffer_size, void * property_value_buffer, void * property_value_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8833822099b299b685c9705f(int64_t event, int32_t property_id, uint32_t property_value_buffer_size, void * property_value_buffer, void * property_value_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b5ddcc9912a62eeb225bc6de(int64_t event_metadata, int32_t property_id, uint32_t flags, uint32_t event_metadata_property_buffer_size, void * event_metadata_property_buffer, void * event_metadata_property_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
uint32_t moonbit_win32_559a87dab6977a0ea04d1b50(uint32_t buffer_size, void * buffer, void * buffer_used) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e9dd341afc3ffdfbfed0bbc1(int64_t log, int32_t property_id, uint32_t property_value_buffer_size, void * property_value_buffer, void * property_value_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_94460ca651e682b95ef0c97d(int64_t object_array, uint32_t property_id, uint32_t array_index, uint32_t flags, uint32_t property_value_buffer_size, void * property_value_buffer, void * property_value_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_8d114d3722dda7931079e1c5(int64_t object_array, void * object_array_size, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f6a00cd9a7534b93b0e6c341(int64_t publisher_metadata, int32_t property_id, uint32_t flags, uint32_t publisher_metadata_property_buffer_size, void * publisher_metadata_property_buffer, void * publisher_metadata_property_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_25ead78d8e2035df3d62c413(int64_t query_or_subscription, int32_t property_id, uint32_t property_value_buffer_size, void * property_value_buffer, void * property_value_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_01acae273dfc8ae933b3efd9(int64_t result_set, uint32_t events_size, void * events, uint32_t timeout, uint32_t flags, void * returned, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4f958b9ade327ec9c82b7d9e(int64_t channel_enum, uint32_t channel_path_buffer_size, void * channel_path_buffer, void * channel_path_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_84d6d20a1b4df97deedcf6c4(int64_t event_metadata_enum, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_2dec7f579a3e91278f3de866(int64_t publisher_enum, uint32_t publisher_id_buffer_size, void * publisher_id_buffer, void * publisher_id_buffer_used, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_920cfc0ce2e2e14d89bb1e57(int64_t session, void * channel_path, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_cf25c90b7a30c8b39ddcb00c(int64_t session, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_801dd87c2a590950a443b4a6(int64_t publisher_metadata, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_46039059d972effcf160858c(int64_t session, void * path, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_ff1852025596580e7bedef20(int64_t session, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_29f6327ff34d7e09aedac4a5(int64_t session, void * publisher_id, void * log_file_path, uint32_t locale, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_24840e27e8d98e5022fac52f(int32_t login_class, void * login, uint32_t timeout, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_a63aa9c0809640293312123b(int64_t session, void * path, void * query, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_f7a57522b252ec0a23e3ee23(int64_t context, int64_t fragment, uint32_t flags, uint32_t buffer_size, void * buffer, void * buffer_used, void * property_count, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_b7d01a5e346a580efc903db0(int64_t channel_config, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cd53426ea09b4704da43efea(int64_t result_set, int64_t position, int64_t bookmark, uint32_t timeout, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_d6d83143da540c81a3690a91(int64_t channel_config, int32_t property_id, uint32_t flags, void * property_value, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int64_t moonbit_win32_3425442ec75a8ad5722c6df1(int64_t session, void * signal_event, void * channel_path, void * query, int64_t bookmark, void * context, void * callback, uint32_t flags, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_84cf6ece9fbd5ff0a4ee633d(int64_t bookmark, int64_t event, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_9b3ddf8a98d0e6684ddc155e(void * h_event_log, uint32_t dw_info_level, void * lp_buffer, uint32_t cb_buf_size, void * pcb_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a2f575d13fe503d6651396d1(void * h_event_log, void * number_of_records, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_4943e012bafae0885d2748b2(void * h_event_log, void * oldest_record, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_e162f5b0b55ea9395b7bad90(void * h_event_log, void * h_event, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_16898d286fc139b2af12ed48(void * lp_unc_server_name, void * lp_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_1661c4ffd97467993b2d4b1c(void * lp_unc_server_name, void * lp_file_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_0b0eaab69ea2f58eb0c22155(void * lp_unc_server_name, void * lp_source_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_19534a1b4a3d903af686422c(void * lp_unc_server_name, void * lp_source_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_a40cd4dd6250a7df9eca905f(void * h_event_log, uint32_t dw_read_flags, uint32_t dw_record_offset, void * lp_buffer, uint32_t n_number_of_bytes_to_read, void * pn_bytes_read, void * pn_min_number_of_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_efef911397c2bca543d87b7f(void * h_event_log, uint32_t dw_read_flags, uint32_t dw_record_offset, void * lp_buffer, uint32_t n_number_of_bytes_to_read, void * pn_bytes_read, void * pn_min_number_of_bytes_needed, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_5e444e20c90106aefda53be8(void * lp_unc_server_name, void * lp_source_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
void * moonbit_win32_cd9c07028324bdc0a6df1d6e(void * lp_unc_server_name, void * lp_source_name, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_86782e1ac567026f0b9b9cef(void * h_event_log, uint32_t w_type, uint32_t w_category, uint32_t dw_event_id, void * lp_user_sid, uint32_t w_num_strings, uint32_t dw_data_size, void * lp_strings, void * lp_raw_data, uint32_t *last_error_) {
...
MOONBIT_FFI_EXPORT
int32_t moonbit_win32_cf3ac57720d637470d63ca32(void * h_event_log, uint32_t w_type, uint32_t w_category, uint32_t dw_event_id, void * lp_user_sid, uint32_t w_num_strings, uint32_t dw_data_size, void * lp_strings, void * lp_raw_data, uint32_t *last_error_) {
