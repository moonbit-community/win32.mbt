...
/// Read-only access used by the vendored WinMD differential oracle.
///
/// This deliberately exposes the exact parser and semantic types consumed by
/// windows-bindgen without making the internal modules themselves public.
#[doc(hidden)]
pub mod oracle {
    pub use crate::tables::{
        Attribute, ClassLayout, Constant, Field, GenericParam, ImplMap, InterfaceImpl, MemberRef,
        MethodDef, MethodParam, ModuleRef, NestedClass, TypeDef, TypeRef, TypeSpec,
    };
    pub use crate::types::Type;
    pub use crate::value::Value;
    pub use crate::winmd::{
        AsRow, Blob, Decode, File, HasAttributes, MethodCallAttributes, Reader, RowIterator,
        TypeDefOrRef, ELEMENT_TYPE_ARRAY, ELEMENT_TYPE_BOOLEAN, ELEMENT_TYPE_BYREF,
        ELEMENT_TYPE_CHAR, ELEMENT_TYPE_CLASS, ELEMENT_TYPE_GENERICINST, ELEMENT_TYPE_I,
        ELEMENT_TYPE_I1, ELEMENT_TYPE_I2, ELEMENT_TYPE_I4, ELEMENT_TYPE_I8, ELEMENT_TYPE_OBJECT,
        ELEMENT_TYPE_PTR, ELEMENT_TYPE_R4, ELEMENT_TYPE_R8, ELEMENT_TYPE_STRING,
...
fn expand_input(input: &[&str]) -> Vec<File> {
    ...
    if use_default {
        panic!("the reader-only vendored crate does not include default WinMD payloads");
    }
